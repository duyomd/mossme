...
return [
    ...
    'magicLinkDetails'   => 'हमने आपको एक ईमेल भेजा है जिसमें लॉगिन लिंक है। यदि आपको यह नहीं मिल रहा है, तो कृपया अपने स्पैम/जंक फ़ोल्डर की जाँच करें। यह केवल {0} मिनट के लिए मान्य है।',
    ...
    'emailActivateBody'     => 'हमने अभी आपको एक कोड के साथ एक ईमेल भेजा है जिससे आपके ईमेल पते की पुष्टि की जा सके। यदि आपको यह नहीं मिल रहा है, तो कृपया अपने स्पैम/जंक फ़ोल्डर की जाँच करें। वह कोड कॉपी करें और नीचे पेस्ट करें।',
