...
return [
    ...
    'magicLinkDetails'   => 'আমরা আপনাকে একটি লগইন লিঙ্ক সহ একটি ইমেইল পাঠিয়েছি। আপনি যদি এটি খুঁজে না পান, অনুগ্রহ করে আপনার স্প্যাম/জাঙ্ক ফোল্ডারটি পরীক্ষা করুন। এটি শুধুমাত্র {0} মিনিটের জন্য বৈধ।',
    ...
    'emailActivateBody'     => 'আমরা একটি কোড সহ একটি ইমেইল আপনাকে পাঠিয়েছি যাতে আপনার ইমেইল ঠিকানা নিশ্চিত করা যায়। আপনি যদি এটি খুঁজে না পান, অনুগ্রহ করে আপনার স্প্যাম/জাঙ্ক ফোল্ডারটি পরীক্ষা করুন। কোডটি কপি করুন এবং নিচে পেস্ট করুন।',
