...
return [
    ...
    'magicLinkDetails'   => '我們剛剛向您發送了一封電子郵件，其中包含登入鏈接。如果您找不到，請檢查您的垃圾郵件文件夾。該鏈接僅在 {0} 分鐘內有效。',
    ...
    'emailActivateBody'     => '我們剛剛向您發送了一封電子郵件，其中包含確認您的電子郵件地址的代碼。如果您找不到，請檢查您的垃圾郵件文件夾。複製該代碼並將其粘貼在下面。',
