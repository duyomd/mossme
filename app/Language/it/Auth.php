...
return [
    ...
    'bannedUser'            => 'Impossibile effettuare l’accesso perché sei attualmente bannato.',
    'logOutBannedUser'      => 'Sei stato disconnesso perché sei stato bannato.',
    ...
    'magicLinkDetails'   => 'Ti abbiamo appena inviato una mail contenente un Login link. Se non lo trovi, controlla la tua cartella Spam/posta indesiderata. È valido solo per {0} minuti.',
    ...
    'newPasswordConfirm'        => 'Nuova password (di nuovo)',
    'changePasswordBtn'         => 'Aggiorna',
    'changePasswordTime'        => 'Puoi cambiare la password se lo desideri.',
    'changePasswordSuccess'     => 'La nuova password è stata cambiata con successo.',
    ...
    'errorPasswordTooLongBytes' => 'La password non può superare i {param} byte di lunghezza.',
    ...
    'emailActivateBody'     => 'Ti abbiamo mandato una email con un codice per confermare il tuo indirizzo email. Se non lo trovi, controlla la tua cartella Spam/posta indesiderata. Copia quel codice e incollalo qui sotto.',
    ...
    'activationBlocked'     => 'Devi attivare il tuo account prima di accedere.',
