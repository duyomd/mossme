  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li class="dropdown"><a href="javascript:void(0)"><span><?=lang('App.languages')?></span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="javascript:void(0)" class="disabled" onclick="changeLanguage('ko')"><?=lang('App.language_me', [], 'ko')?></a></li>
              ...
              <li><a href="javascript:void(0)" class="disabled" onclick="changeLanguage('ru')"><?=lang('App.language_me', [], 'my')?></a></li>
            </ul>
          </li>          
